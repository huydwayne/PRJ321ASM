                        ...
                        <div class="container">
                            <form action="UpdateProductServlet" method = "POST" enctype="multipart/form-data">
                                <div class="controls">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"> <label for="form_name">Product ID *</label> <input readonly type="text" name="id" class="form-control"  value="${requestScope.product.id}" placeholder="Please enter your product ID *"> </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"> <label for="form_lastname">Product Name *</label> <input type="text" value="${requestScope.product.name}" name="name" class="form-control" placeholder="Please enter your product name *"> </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"> <label for="form_email">Product Price *</label> <input type="number" value="${requestScope.product.price}" name="price" class="form-control" placeholder="Please enter your product price *"> </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group"> <label for="form_message">Product Description *</label> <input value="${requestScope.product.description}" name="description" class="form-control" placeholder="Write your product description here."></div>
