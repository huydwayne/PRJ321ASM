...
//            }
            ...
            if (price.trim().length() < 1 || Double.parseDouble(price) <= 0) {
            ...
            if (isChecked) {
                ...
                rs = dao.updateProduct(new ProductDTO(id, name, description, Double.parseDouble(price), imgUrl));
