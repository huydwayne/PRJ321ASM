    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ArrayList<ProductDTO> listProducts = new ArrayList<>();
                ...
                for (ProductDTO listProduct : listProducts) {
                if (listProduct.getImage()!=null){
                    FileImages.copyImgToContextFolder(request.getServletContext().getRealPath("/images"), listProduct.getImage());
                }
            }
